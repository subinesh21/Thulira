...
export default function AdminDashboard() {
  ...
  const getButtonClass = (path) => {
    const baseClass = 'flex flex-col items-center p-4 bg-gray-50 hover:bg-[#52dd28ff]/10 rounded-box transition-all duration-200 border border-gray-200 hover:border-[#52dd28ff] focus:outline-none focus:ring-1 focus:ring-[#52dd28ff]';
  ...
  const getBgClass = (path) => {
    const baseClass = 'p-2.5 bg-white rounded-box mb-2 group-hover:bg-[#52dd28ff]/10 transition-colors duration-200';
    return clickedButton === path
  ...
  const getRefreshButtonClass = () => {
    const baseClass = 'px-5 py-2.5 bg-[#52dd28ff] text-white rounded-box text-sm font-medium hover:bg-[#45b824] transition-colors duration-200 flex items-center gap-2 focus:outline-none focus:ring-1 focus:ring-[#52dd28ff]';
    return isRefreshing
    ...
    <AdminLayout>
      <div className="space-y-5">
        ...
        <motion.div
          ...
          className="bg-white border border-gray-200 overflow-hidden rounded-box"
        >
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right ml-3">
                      ...
                      <span className={`inline-block px-2 py-0.5 text-xs font-medium rounded-box mt-1 ${order.status === 'pending' ? 'bg-yellow-100 text-yellow-800' :
              ...
              stats.recentUsers.map((user, index) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-xs text-gray-400 bg-gray-100 px-2 py-1 ml-2 whitespace-nowrap rounded-box">
                      {user.joined}
                    </span>
                  </div>
                </motion.div>
        ...
        <div className="sm:hidden mt-4 flex justify-center">
          <button
            onClick={refreshData}
            disabled={isRefreshing}
            className="px-4 py-2 bg-[#52dd28ff] text-white rounded-box text-xs font-medium hover:bg-[#45b824] transition-colors duration-200 flex items-center gap-1.5 focus:outline-none focus:ring-1 focus:ring-[#52dd28ff]"
          >
            {isRefreshing ? (
              <>
